...
public class NC_Min_Window_Substring {
    /**
     * <ul>
     *     <li>
     *         <b>Min Window Substring</b><br>
     *         Have the function MinWindowSubString({@code strArr}) take the array of strings
     *         stored in {@code strArr}, which will contain only 2 strings, the first parameter
     ...
     *         of N that contains all the characters in K is "aabd" which is located at the
     *         beginning of the string. Both parameters will be strings ranging in length from 1
     *         to 50 characters and all of K's characters will exist somewhere in the string N.
